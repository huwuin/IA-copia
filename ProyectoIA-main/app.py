...
class App:
    def __init__(self, root, origen_param=None, destino_param=None):
        ...
        #Parametros de las ventanas y frames de la web
        ...
        #Seleccionar valores por defecto si hay parámetros
        ...
        #Imagen del tren para animación
        try:
    ...
    def calcular_ruta(self):
        ...
        #Usar ruta y tiempo devueltos por A*
        try:
